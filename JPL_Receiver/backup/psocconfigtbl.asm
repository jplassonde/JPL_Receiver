...
export LoadConfigTBL_jpl_receiver_Bank1
export LoadConfigTBL_jpl_receiver_Bank0
export LoadConfigTBL_jpl_receiver_Ordered
AREA lit(rom, rel)
LoadConfigTBL_jpl_receiver_Bank0:
;  Instance name LCD, User Module LCD
;  Instance name SHADOW_P0, User Module SHADOWREGS
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_jpl_receiver_Bank1:
;  Instance name LCD, User Module LCD
;  Instance name SHADOW_P0, User Module SHADOWREGS
;  Instance name SPIM, User Module SPIM
;       Instance name SPIM, Block Name SPIM(DCB02)
	...
	db		2ah, 6eh		;SPIM_OUTPUT_REG   (DCB02OU)
;  Instance name SleepTimer, User Module SleepTimer
...
LoadConfigTBL_jpl_receiver_Ordered:
;  Ordered Global Register values
	M8C_SetBank0
	mov	reg[00h], 00h		; Port_0_Data register (PRT0DR)
	M8C_SetBank1
	mov	reg[00h], 66h		; Port_0_DriveMode_0 register (PRT0DM0)
	mov	reg[01h], 99h		; Port_0_DriveMode_1 register (PRT0DM1)
	M8C_SetBank0
	mov	reg[03h], 81h		; Port_0_DriveMode_2 register (PRT0DM2)
	mov	reg[02h], 70h		; Port_0_GlobalSelect register (PRT0GS)
	M8C_SetBank1
