...
export LoadConfig_jpl_receiver
export _LoadConfig_jpl_receiver
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_jpl_receiver
	lcall	LoadConfigTBL_jpl_receiver_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration jpl_receiver
;
;    Load configuration registers for jpl_receiver.
...
;               CUR_PP
;
_LoadConfig_jpl_receiver:
 LoadConfig_jpl_receiver:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_jpl_receiver_Bank0
    mov     X, <LoadConfigTBL_jpl_receiver_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_jpl_receiver_Bank1
    mov     X, <LoadConfigTBL_jpl_receiver_Bank1
